...
const RegisterPage: React.FC = () => {
  ...
  const { register, loginWithGoogle, sendMagicLink } = useAuth();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success('Account created successfully! Welcome to SpendSmart!');
    } catch (error) {
      toast.error(
  ...
  const handleMagicLinkSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success(
        'Magic link sent! Check your email and click the link to sign in or create your account.'
      );
    } catch (error) {
      toast.error(
